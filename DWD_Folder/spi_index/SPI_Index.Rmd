...
spi_3_annual_plot <- spi_3 |> 
    ...
    theme(
        ...
        panel.background = element_blank(),  # Set panel background to light grey
        plot.background = element_blank(),   # Set plot background to light grey
        panel.grid.minor = element_blank(),  # Keep minor grid lines off
        panel.grid.major = element_blank(),,  # Set major grid lines to black for visibility
...
spi_6_annual_plot <- spi_6|> 
   ...
   scale_y_continuous(
    ...
    theme(
        ...
        plot.background = element_blank(),   # Set plot background to light grey
        panel.grid.minor = element_blank(),  # Keep minor grid lines off
        panel.grid.major = element_line( size = 0.5),  # Set major grid lines to black for visibility
        axis.line.y.right = element_line(color = "black", size = 1),
        axis.text.y.right = element_text(face = "bold", color = "black"),
        axis.title.y.right = element_text(face = "bold", color = "black", angle = 90),
    ) +
