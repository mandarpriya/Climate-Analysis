...
ggplot(hwmid_tbl, aes(x = year, y = HWMId)) +
  ...
  geom_hline(yintercept = hwmid_result$T30y75p, linetype = "dashed", color = "darkred") +
  geom_hline(yintercept = hwmid_result$T30y25p, linetype = "dotted", color = "blue") +
  annotate("text", x = 1991, y = hwmid_result$T30y75p + 0.3, label = "75th percentile", color = "darkred", hjust = 0) +
  annotate("text", x = 1991, y = hwmid_result$T30y25p + 0.3, label = "25th percentile", color = "blue", hjust = 0) +
  labs(
    title = "Annual HWMId in Hamburg-Fuhlsbüttel (1990–2024)",
    y = "HWMId",
    x = "Year",
    caption = "Thresholds based on 1936–1989 reference period"
  ) +
  theme_minimal(base_size = 14)
