...
prec_tbl <- data |> select(date,prec) |> drop_na()
...
ggsave(
  filename = file.path(plot_dir, "Annual_Temperature_Trend.png"),
  plot = last_plot(),
  width = 15,
  height = 10,
  dpi = 450
...
ggsave(
  filename = file.path(plot_dir, "Decadal_Temperature_Bar.png"),
  plot = last_plot(),
  width = 15,
  height = 10,
  dpi = 450
...
ggsave(
  filename = file.path(plot_dir, "Decadal_Temperature_Line.png"),
  plot = last_plot(),
  width = 15,
  height = 10,
  dpi = 450
...
ggsave(
  filename = file.path(plot_dir, "Heatwave_Intensity_Trend_1990_2024.png"),
  plot = last_plot(),
  width = 18,
  height = 12,
  dpi = 450
...
ggsave(
  filename = file.path(plot_dir, "Heatwave_Max_Exceedance_1990_2024.png"),
  plot = last_plot(),
  width = 15,
  height = 10,
  dpi = 450
...
ggplot(peak_day_tbl, aes(x = year, y = peak_day)) +
  ...
  theme_minimal(base_size = 14)
ggsave(
  filename = file.path(plot_dir, "HWMId_Peak_Julian_Day_Line.png"),
  plot = last_plot(),
  width = 15,
  height = 10,
  dpi = 450
...
ggsave(
  filename = file.path(plot_dir, "Heatwave_Peak_Month_Count.png"),
  plot = last_plot(),
  width = 15,
  height = 10,
  dpi = 450
...
peak_day_tbl %>%
  ...
  theme_minimal(base_size = 14)
ggsave(
  filename = file.path(plot_dir, "Peak_Months_by_Decade.png"),
  plot = last_plot(),
  width = 15,
  height = 10,
  dpi = 450
...
ggsave(
  filename = file.path(plot_dir, "Heatwave_Frequency_Climatology_Period.png"),
  plot = last_plot(),
  width = 15,
  height = 10,
  dpi = 450
...
exceed_28c_events %>%
  ...
  theme_minimal(base_size = 14)
ggsave(
  filename = file.path(plot_dir, "Exceedance_28C_Frequency_Annual.png"),
  plot = last_plot(),
  width = 15,
  height = 10,
  dpi = 450
...
ggplot(exceed_28c_events, aes(x = date_peak, y = rate_decline)) +
  ...
  theme_minimal(base_size = 14)
ggsave(
  filename = file.path(plot_dir, "Exceedance_Rate_Decline.png"),
  plot = last_plot(),
  width = 15,
  height = 10,
  dpi = 450
...
ggsave(
  filename = file.path(plot_dir, "Top10_Slowest_Decline_Rate.png"),
  plot = last_plot(),
  width = 15,
  height = 10,
  dpi = 450
...
ggplot(top10_duration, aes(x = duration, y = reorder(as.character(date_peak), duration))) +
  ...
  theme(
    plot.title.position = "plot",
    plot.title = element_text(face = "bold", size = 22, margin = margin(b=15)),
    plot.subtitle  = element_text(face = "bold", size = 18, margin = margin(b=10)),
    axis.text.y = element_text(face = "bold"),
    legend.position = "right"
  ) +
...
ggsave(
  filename = file.path(plot_dir, "Top10_Longest_Heatwaves.png"),
  plot = last_plot(),
  width = 15,
  height = 10,
  dpi = 450
...
ggsave(
  filename = file.path(plot_dir, "Top10_Max_Intensity_Events.png"),
  plot = last_plot(),
  width = 20,
  height = 10,
  dpi = 450
